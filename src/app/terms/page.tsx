                  ...
                  <div key={i}>
                    ...
                    {"privacyLink" in block && block.privacyLink && (
                      <p className="mt-2 text-sm text-white/40">
                        Read our full{" "}
                        <Link href="/privacy"
                          className="text-purple-300/80 underline underline-offset-2 transition-colors hover:text-purple-300">
                          Privacy Policy
                        </Link>
                        .
                      </p>
                    ...
                    {"contact" in block && block.contact && (
                      <div className="mt-4 rounded-xl border border-white/[0.07] p-5"
                        ...
                        <a href={`mailto:${block.contact.email}`}
                          className="mt-1 block text-sm text-purple-300/80 transition-colors hover:text-purple-300">
                          {block.contact.email}
                        </a>
