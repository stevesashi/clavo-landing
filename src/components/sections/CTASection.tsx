...
export default function CTASection() {
  return (
    <section
      ...
      style={{ background: "linear-gradient(180deg, #030608 0%, #04090e 100%)" }}
    >
      {/* Ambient glow */}
      <div aria-hidden="true" className="pointer-events-none absolute inset-0">
        <div
          ...
          style={{
            ...
            background:
              "radial-gradient(ellipse, rgba(217,119,6,0.10) 0%, rgba(139,92,246,0.07) 50%, transparent 72%)",
          }}
        />
      </div>
      ...
      <span
        ...
        style={{
          background:
            "linear-gradient(90deg, transparent, rgba(217,119,6,0.40) 35%, rgba(139,92,246,0.35) 65%, transparent)",
        }}
      />
      ...
      <div className="relative z-10 mx-auto max-w-2xl text-center">
        ...
        <p className="mx-auto mb-3 max-w-md text-base leading-relaxed text-white/45">
          ...
          <span className="font-semibold text-amber-300/90">lifetime access at $699/mo</span>
          {" "}— down from $999/mo.
        </p>
        ...
        <div className="mt-8 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
          ...
          <a
            ...
            style={{
              ...
              boxShadow:
                "0 0 28px rgba(217,119,6,0.42), 0 0 60px rgba(217,119,6,0.12), 0 4px 24px rgba(0,0,0,0.5)",
