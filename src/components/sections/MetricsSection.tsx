...
function ComparisonBar({
  ...
  industryLabel,
  color,
  invert = false,  // invert = lower is better (cost, time)
}: {
  clavoValue: number;
...
export default function MetricsSection() {
  return (
    ...
    >
      {/* Atmospheric glows — hidden on mobile to reduce visual noise */}
      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        ...
        <motion.div className="mb-10 md:mb-16 text-center"
          ...
          <p className="mx-auto mt-4 max-w-xl text-base leading-relaxed text-white/38">
            Every number below comes from active Clavo AI deployments across fast-scaling hiring teams in GCC & APAC.
        ...
        >
          {[
            { value: "15 Days",  label: "Time to Hire",       sub: "vs 40 days avg",  color: "#fbbf24" },
        ...
        >
          <p className="text-lg font-semibold text-white/60">
            ...
            <span className="text-amber-300 font-bold">saves AED 10,800 per hire</span>{" "}
            and fills roles{" "}
            <span className="text-cyan-300 font-bold">62% faster</span>{" "}
            than before.
          </p>
          <p className="text-sm text-white/25 italic">
            Based on aggregated data from hiring teams across GCC & APAC · Updated April 2026
          </p>
        </motion.div>
      </div>
    </section>
