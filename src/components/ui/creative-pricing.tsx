...
function CreativePricing({
  ...
  return (
    <div className="relative w-full max-w-6xl mx-auto px-4">
      ...
      {/* Decorative doodles */}
      <div aria-hidden="true" className="absolute -z-10 inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-40 left-20 text-4xl rotate-12 text-zinc-400/30 dark:text-white/10">
          ✎
        </div>
        <div className="absolute bottom-40 right-20 text-4xl -rotate-12 text-zinc-400/30 dark:text-white/10">
          ✏️
        </div>
      </div>
    </div>
